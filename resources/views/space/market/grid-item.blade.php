<a href="{{$book->getUrl()}}" class="grid-card"  data-entity-type="book" data-entity-id="{{$book->id}}">
    ...
    <div class="grid-card-footer">
        <span style="line-height: 2em;"><b style="color:darkred;font-size: 1.5em;">{{$book->market->price}}</b> 蚂蚁币 <button style="padding:1px 5px;float:right;" class="button outline" type="button">{{ trans('market.purchase') }}</button></span>
    </div>
</a>