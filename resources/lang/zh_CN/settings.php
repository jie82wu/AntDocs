...
return [
    ...
    'role_manage_entity_permissions' => '管理所有空间，图书，章节和页面的权限',
    'role_manage_own_entity_permissions' => '管理自己的空间，图书，章节和页面的权限',
    'role_manage_settings' => '管理App设置',
    'role_asset' => '资源许可',
    'role_asset_desc' => '对系统内资源的默认访问许可将由这些权限控制。单独设置在空间，书籍，章节和页面上的权限将覆盖这里的权限设定。',
